...
class HomeController extends GetxController {
  ...
  bool addTodo(String title) {
    ...
    if(doingTodos.any((element) => mapEquals<String, dynamic>(doingTodo,element))){
      return false;
    }
    var  dontTodo = {'title':title,'done':true};
    if(doneTodos.any((element) => mapEquals<String, dynamic>(dontTodo,element))){
      return false;
    }
